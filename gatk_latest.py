...
gatk_dir='/lgc/programs/GenomeAnalysisTK-2.3-6-gebbba25'
...
indels="/lgc/datasets/gatk_data/2.3/1000G_phase1.indels.hg19.vcf"
indels="/lgc/datasets/gatk_data/2.3/b37/1000G_phase1.indels.b37.vcf"
...
class Gatk():
    def __init__(self, input_file):
      ...
      input_file = self.AddorReplaceGroups(input_file, False)
    ...
    def BaseQualityScoreRecalibration(self, input_file, flag=True):
      ...
      """ % (gatk_dir, input_file, reference, indels)#actually was dbsnp
